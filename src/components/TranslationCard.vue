...
const lookupTerms = ref(new Set<string>([termChinese.value, termExample.value]))
...
async function lookup() {
  ...
  const result = await openAIResult(selectedWord, lookupTerms, termChinese, termEnglish, termExample)
